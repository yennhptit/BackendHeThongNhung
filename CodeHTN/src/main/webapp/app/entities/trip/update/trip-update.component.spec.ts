...
describe('Trip Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Driver query and add missing value', () => {
      ...
      const driver: IDriver = { id: 19371 };
      trip.driver = driver;

      const driverCollection: IDriver[] = [{ id: 19458 }];
    ...
    it('Should call Vehicle query and add missing value', () => {
      const trip: ITrip = { id: 456 };
      const vehicle: IVehicle = { id: 9077 };
      trip.vehicle = vehicle;

      const vehicleCollection: IVehicle[] = [{ id: 21004 }];
    ...
    it('Should update editForm', () => {
      const trip: ITrip = { id: 456 };
      const driver: IDriver = { id: 29595 };
      trip.driver = driver;
      const vehicle: IVehicle = { id: 18888 };
      trip.vehicle = vehicle;
