...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './violation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIOLATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIOLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIOLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIOLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIOLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIOLATION actions', async () => {
      const expectedActions = [
        {
