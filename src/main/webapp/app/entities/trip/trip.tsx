  ...
  return (
    <div>
      <h2 id="trip-heading" data-cy="TripHeading">
        <Translate contentKey="backendHeThongNhungApp.trip.home.title">Trips</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="backendHeThongNhungApp.trip.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/trip/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="backendHeThongNhungApp.trip.home.createLabel">Create new Trip</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tripList && tripList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="backendHeThongNhungApp.trip.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="backendHeThongNhungApp.trip.vehicle">Vehicle</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="backendHeThongNhungApp.trip.home.notFound">No Trips found</Translate>
            </div>
          )
        )}
      </div>
